...
**The Excel Sheet** - Phil drew three different downward lines on an excel sheet. One for his actual weight, one for the maximum weight he can go up and one for the minimum weight he can go down. The downward slope of max and min weight follows the pattern - today's weight should be less than (0.1%) of the previous weight. Pretty easy?. The downward slope of his actual weight is his actual weight. He plotted his weight against the excel sheet every day. It was not always down. Sometimes, it goes up. But the weight reduction is very gradual over the period of two years.  
...
![Weight Tracker]({{site.img-path}}/weight-tracker.png)  
...
[xl-tracker-url]: {{site.download-path}}/weight-tracker.xls
...
* In the 'Data' Worksheet, just add your current weight to 'Actual Weight' column every day  
